...
{
    public partial class Jeu1 : Form
    {
        public Jeu1()
        {
            InitializeComponent();
        ...
        private void Form1_KeyDown(object sender, KeyEventArgs e)
        {
            switch (e.KeyCode)
            {
                case Keys.W:
                    ...
                    //(this.PacmanGroupBox.Controls[1] as Characters.ICharacter).Move(Characters.MovementWay.Up);
                    break;

                case Keys.S:
                    (this.PacmanGroupBox.Controls[0] as Characters.ICharacter).Move(Characters.MovementWay.Down);
                    //(this.PacmanGroupBox.Controls[1] as Characters.ICharacter).Move(Characters.MovementWay.Down);
                    break;

                case Keys.A:
                    (this.PacmanGroupBox.Controls[0] as Characters.ICharacter).Move(Characters.MovementWay.Left);
                    //(this.PacmanGroupBox.Controls[1] as Characters.ICharacter).Move(Characters.MovementWay.Left);
                    break;

                case Keys.D:
                    (this.PacmanGroupBox.Controls[0] as Characters.ICharacter).Move(Characters.MovementWay.Right);
                    //(this.PacmanGroupBox.Controls[1] as Characters.ICharacter).Move(Characters.MovementWay.Right);
                    break;
            }
        }
